  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-[#0066CC] via-[#0052A3] to-[#7B3FF2]">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-3 text-base leading-relaxed text-white/80 md:text-lg">
              Connect with fellow Delhi Metro travelers on your route, right
          ...
          <div className="rounded-2xl bg-white p-6 shadow-2xl md:p-8">
            <Button
              ...
              className="h-12 w-full gap-3 rounded-lg bg-[#1A1A1A] text-[15px] font-medium text-white hover:bg-[#333333]"
            >
      ...
      <footer className="pb-6 text-center text-xs text-white/50">
        Metro Connect v1.0 &middot; Made for Delhi Metro Travelers
      </footer>
    </div>
  );
}
